...
void NetConfig::onWiFiEvent(WiFiEvent_t event)
{
    ...
    case WIFI_EVENT_STAMODE_DISCONNECTED: {
        if(_started) {
            ...
            ESP3DOutput::toScreen(ESP_OUTPUT_STATUS, "Disconnected");
    ...
    case WIFI_EVENT_SOFTAPMODE_STACONNECTED: {
        ...
        ESP3DOutput::toScreen(ESP_OUTPUT_STATUS, "New client");
    }
    break;
#ifdef ARDUINO_ARCH_ESP32
    ...
    case SYSTEM_EVENT_ETH_CONNECTED: {
        ...
        ESP3DOutput::toScreen(ESP_OUTPUT_STATUS, "Cable connected");
    }
    break;
    case SYSTEM_EVENT_ETH_DISCONNECTED: {
        output.printMSG ("Cable disconnected");
        ESP3DOutput::toScreen(ESP_OUTPUT_STATUS, "Cable disconnected");
    }
    break;
...
#pragma GCC diagnostic pop
    ...
    if (espMode == ESP_NO_NETWORK) {
        ...
        if (Settings_ESP3D::isVerboseBoot()) {
            ESP3DOutput output(ESP_ALL_CLIENTS);
            ESP3DOutput::toScreen(ESP_OUTPUT_STATUS, RADIO_OFF_MSG);
